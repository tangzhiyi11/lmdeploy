    ...
    async def _async_loop_background(self, forward_event: asyncio.Event = None):
        ...
        with self.all_context(), torch.cuda.stream(self.stream), torch.inference_mode():
            ...
            while True:
                ...
                forward_inputs['inputs'].seq_length_npu = forward_inputs['inputs'].seq_length_npu
                forward_inputs['inputs'].seq_length = forward_inputs['inputs'].seq_length.cpu()
                forward_inputs['inputs'].num_ignored_history_npu = forward_inputs['inputs'].num_ignored_history_npu
